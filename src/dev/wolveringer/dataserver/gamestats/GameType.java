...
public enum GameType {
	...
	TEAMS_PVP(false,"teams_pvp","teams_pvp",ServerType.PVP,new StatsKey[] {StatsKey.TEAM_ID, StatsKey.TEAM_NAME, StatsKey.TEAM_PREFIX, StatsKey.WORLD, StatsKey.LOC_X, StatsKey.LOC_Y, StatsKey.LOC_Z},false, null),
	TEAMS_SKYBLOCK(false,"teams_skyblock","teams_skyblock",ServerType.SKYBLOCK,new StatsKey[] {StatsKey.TEAM_ID, StatsKey.TEAM_NAME, StatsKey.TEAM_PREFIX, StatsKey.WORLD, StatsKey.LOC_X, StatsKey.LOC_Z},false, null),
	TEAMS_WARZ(false,"teams_warz","teams_warz",ServerType.WARZ,new StatsKey[] {StatsKey.TEAM_ID, StatsKey.TEAM_NAME, StatsKey.TEAM_PREFIX},false, null),
	...
	Masterbuilders(true, "MasterBuilders", "MB", ServerType.GAME, new StatsKey[] { StatsKey.LOSE, StatsKey.WIN},true, TEAMS_ACARDE),
